...
export function GET() {
  ...
  for (const post of getAllPosts()) sections.push("", "### " + post.title, "", "URL: " + absoluteUrl("/blog/" + post.slug), "Category: " + post.category, "Published: " + post.publishedAt, "Author: " + post.author, "", post.content);
